                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                ...
                                <div id="Choice" value="Choice" name="Choice">
                                    <button type="submit" name="Choice" value="Search" class="btn btn-primary" onclick="return(validateSearch());">Search</button>
                                    <button type="submit" name="Choice" value="Insert" class="btn btn-primary" onclick="return(validateAdd());">Add</button>
                                    <button type="submit" name="Choice" value="Update" class="btn btn-primary" onclick="return(validateUpdate());">Update</button>
                                </div>
                            </div>
